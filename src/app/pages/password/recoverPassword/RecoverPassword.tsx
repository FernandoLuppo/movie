        ...
        <div className="RecoverPassword-container">
            ...
            {display === false ? 
                <div>
                    ...
                    <Input placeholder="Coloque seu E-mail..." onChange={e => setEmail(e.target.value)} />
            ...
            :
                <div id="verificationContainer">
                    ...
                    <Input onChange={e => setEmailCode(e.target.value)} mask="justNumber" className="RecoverPassword-code-input" maxLength={6} />
